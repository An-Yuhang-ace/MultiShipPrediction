...
from helper import *
from model import getSequenceGridMask, getGridMask
    ...
    for iteration in range(sample_args.iteration):
        ...
        for batch in range(dataloader.num_batches):
            ...
            if sample_args.method == 3: #vanilla lstm
                ...
                ret_x_seq = sample(obs_traj, obs_PedsList_seq, sample_args, net, x_seq, PedsList_seq, saved_args, dataloader, lookup_seq, numPedsList_seq, sample_args.gru)
...
def sample(x_seq, Pedlist, args, net, true_x_seq, true_Pedlist, saved_args, dataloader, look_up, num_pedlist, is_gru, grid = None):
    '''
    The sample function
    params:
    ...
    with torch.no_grad():
        ...
        for tstep in range(args.obs_length-1, args.pred_length + args.obs_length-1):
            ...
            true_Pedlist[tstep+1] = [str(_x_seq) for _x_seq in true_Pedlist[tstep+1]]
            ...
            if grid is not None: #no vanilla lstm
                ...
                if args.method == 2: #obstacle lstm
                    prev_grid = getGridMask(current_x_seq.data.cpu(), len(true_Pedlist[tstep+1]),saved_args.neighborhood_size, saved_args.grid_size, True)
